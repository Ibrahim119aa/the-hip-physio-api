...
const allowedOrigins = ['https://www.thehipphysio.com','https://thehipphysio.net', 'http://127.0.0.1:5500', 'https://thehipphysio-6d2j.vercel.app', 'http://localhost:3000', 'http://localhost:3001']
